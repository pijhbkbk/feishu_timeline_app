...
运行代码：`bea6dc6f5f6a6d76bdc724d4e2c0e7792ed9fd19`

本矩阵只记录 2026-07-30 在精确生产域名完成的浏览器复核。`localhost`
证据不用于证明生产部署或产品验收。
...
| `/build-info` | `GET route` | Web build metadata | public | 验证 Web 运行身份 | `runtimeCommit=bea6dc6f...` | PASS |
| `/api/health` | `HealthController` | API build metadata | public | 验证 API 运行身份 | `runtimeCommit=bea6dc6f...` | PASS |
